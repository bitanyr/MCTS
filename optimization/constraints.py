...
def define_constraints(model):
    ...
    # Add upper and lower limits for the reactive power of the gas generator.
    ...
    def reactive_power_balance_rule(m, i, t):
        ...
        # توان راکتیو ژنراتور گازسوز (m.Q_gas) به معادله اضافه شد
    ...
    # ظرفیت توان ظاهری بر اساس ضریب توان 0.8
    S_GAS_CAP = P_GAS_MAX * 1.25 
