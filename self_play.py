    ...
    for ep in range(start_ep, total_eps):
        ...
        while True:
            ...
            if info["msg"] == "Feasible":
                ...
                print(f"       Blackout! Solver hit '{info['msg']}'. Pruning branch.")
        ...
        for seq in episode_memory:
            ...
            if target_perf > 0.0 or final_cost > 5000000.0:
                scaled_value = -1.0 
            else:
                ECONOMIC_BASELINE = 5000000.0
                scaled_value = (ECONOMIC_BASELINE - final_cost) / ECONOMIC_BASELINE
